...
const Input = () => {
  return (
    <StyledWrapper>
      <div className="searchBox bg-blue-950">
        <input className="searchInput " type="text" name="search" placeholder="Search something" />
        <button className="searchButton bg-gradient-to-r from-amber-400 to-blue-500" href="#">
