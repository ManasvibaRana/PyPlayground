    ...
    <div className="bg-gradient-to-b from-[#0f0c29] via-[#302b63] to-[#1c1c3a] text-white overflow-x-hidden font-sans">
      ...
      <section className="min-h-screen flex flex-col md:flex-row items-center justify-between px-10 py-20">
        <div className="md:w-1/2 mb-12 md:mb-0">
          <h1 className="text-3xl md:text-5xl font-extrabold mb-6 bg-gradient-to-r from-pink-200 to-purple-500 bg-clip-text text-transparent drop-shadow-lg">
        ...
        <div className="md:w-1/2 flex justify-center">
          <img src={face_recognition} alt="Face Icon" className="w-xs  rounded-3xl shadow-[0_20px_50px_rgba(240,46,170,0.3)]" />
        </div>
      </section>
      ...
      <section className="min-h-screen px-10 py-20">
        ...
        <div className="flex overflow-x-scroll gap-8 snap-x no-scrollbar pb-4">
          {[
            ...
            { img: "/future.webp", title: "Today — Ubiquitous", text: "Phones, airports, doors — face recognition is now a daily reality." },
          ].map((item, idx) => (
      ...
      {/* ✅ Show FaceMain only when clicked */}
      {showDemo && (
